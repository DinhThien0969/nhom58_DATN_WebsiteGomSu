		...
		$.ajax({
			...
			success: function(result){
				$.each(result, function(i, danhmuc){
					var content = '<li><a href="/potteryshop/store?brand='+danhmuc.tenDanhMuc+'"><img alt="" src="Frontend/img/pottery.png" style="color: red"> <span style=" font-size: 16px; font-weight: 900; ">'+danhmuc.tenDanhMuc+'</span></a></li>';
