		...
		<div class="top-3-grids">
			<div class="section group">
				<div class="grid_1_of_3 images_1_of_3">
					<a href="/potteryshop/store?brand=BÌNH TÀI LỘC"><img
						src="Frontend/img/noibat1.jpg"></a>
					<h3>Sản Phẩm Nổi Bật</h3>
				</div>
				<div class="grid_1_of_3 images_1_of_3 ">
					<a href="/potteryshop/store?brand=HỒ LÔ GỐM SỨ"><img
						src="Frontend/img/noibat2.jpg" style="background-color: white"></a>
					<h3>Sản Phẩm Nổi Bật</h3>
				</div>
				<div class="grid_1_of_3 images_1_of_3 ">
					<a href="/potteryshop/store?brand=TRANH GỐM"><img
...
<div style="background: #575757 !important; margin-top: 20px; padding: 10px;display: flex;text-align: center!important;text-align: center  ">
	...
	<div style="width: 400px";>
		<img style="height: 40px;" class="img1 uk-responsive-width" uk-img=""
			...
			src="https://www.xuonggombattrang.vn/logos/icon-tu-van-24-7.png">
		<br>
...
<div id="content">
	<div class="content-section">
		<h1 class="section-heading">THE POTTERY</h1>
		<p class="section-sub-heading">We love pottery</p>
		<p class="about-text">Sản phẩm gốm sứ Bát Tràng được tiêu thụ khá
		...
		<div class="members-list">
			<div class="member-item">
				<p class="member-name">Vò bí chim trĩ hoa đào</p>
				<img src="Frontend/img/contentanh.png" alt="" class="member-img">
			</div>
			<div class="member-item">
				<p class="member-name">Đèn trứng đại CNLH</p>
				<img src="Frontend/img/contentanh2.jpg" alt="" class="member-img">
			</div>
			<div class="member-item">
				<p class="member-name">Vò cao ngàn hoa sứ khử</p>
	...
	<div class="content-section">
		...
		<p class="section-sub-heading">Cửa hàng Thành Phát</p>
	</div>
</div>
