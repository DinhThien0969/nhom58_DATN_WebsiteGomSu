...
<title>top4SoLuongSanPhamCuaNhanVienTheoThang</title>
...
<body>
	...
	<div class="col-md-9 animated bounce">
		...
		<h4 style="text-align: center; padding-right: 10%;color:#D2691E"><b>Top 4 nhân viên có số lượng sản phẩm bán cao nhất trong tháng</b></h4>
...
<script>
	...
	$(document).on('change','#month',function(){
		...
		$.ajax({
			...
			url : "http://localhost:8080/potteryshop/api/don-hang/report/top4SoLuongSanPhamCuaNhanVienTheoThang/"+month,
