		...
		<div class="row">
			...
			<div class="col-md-10">
				...
				<h3 style="line-height: 2;">
					<span style="font-weight: bold">Họ tên: </span></h3>
				<h3 style="line-height: 2;">
					<span style="font-weight: bold">Số điện thoại: </span></h3>
				<h3 style="line-height: 2;">
					<span style="font-weight: bold">Email: </span></h3>
				<h3 style="line-height: 2;">
					<span style="font-weight: bold"> Địa chỉ: </span></h3>
				...
				<table class="table-cart-checkout mytable">
					...
					<c:forEach var="" items="" varStatus="loop">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<textarea rows="3" cols="1" class="form-control" id="address"></textarea>
					</div>
